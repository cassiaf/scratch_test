/*
    PROGRAM CREATED BY szAmmi- JUST TESTING 
    https://github.com/SzAmmi/Scratch-Extension-Speech-recognition/blob/master/speech_recognition.js
    
    'speech_recognition.js' is an extension for Scratch, which allows to run SPEECH-TO-TEXT on Scratch.
    
    
    Copyright (C) 2015 SzAmmi
...
(function(ext) {
    ...
    ext._getStatus = function() {
		if ((new webkitSpeechRecognition()) === undefined) {
			return {status: 1, msg: 'Your browser does not support speech recognition. Try using Google Chrome.'}; // Status 1 = Red, Error // Status 1 = Yellow, Not Ready // Status 2 = Green, Ready
		}
    ...
    ScratchExtensions.register('Speech recognition', descriptor, ext);       // The name is 'Speech recognition'
})({});
